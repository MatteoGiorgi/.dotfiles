...
highlight! NonText                   guibg=#282936 guifg=#626483
...
highlight! CursorLineNr              guibg=#282936 guifg=#F1FA8C gui=bold
highlight! ModeMsg                   guibg=#282936 guifg=#F1FA8C gui=bold

highlight! Cursor                    guibg=#F1FA8C guifg=#282936
highlight! iCursor                   guibg=#F1FA8C guifg=#282936

highlight! Normal                    guibg=#282936 guifg=none
highlight! EndOfBuffer               guibg=#2A2C38 guifg=#2A2C38

highlight! StatusLine                guibg=#3A3C4E guifg=#6699FF gui=bold
highlight! StatusLineNC              guibg=#3A3C4E guifg=#BFBFBF gui=bold
highlight! VertSplit                 guibg=#3A3C4E guifg=#3A3C4E

highlight! TabLineSel                guibg=#3A3C4E guifg=#6699FF gui=bold
highlight! TabLine                   guibg=#3A3C4E guifg=#BFBFBF gui=bold
highlight! TabLineFill               guibg=#3A3C4E guifg=none
...
highlight! BufTabLineFill            guibg=#3A3C4E guifg=none
highlight! BufTabLineModifiedCurrent guibg=#3A3C4E guifg=#6699FF gui=bold
highlight! BufTabLineModifiedActive  guibg=#3A3C4E guifg=#BFBFBF gui=bold
highlight! BufTabLineModifiedHidden  guibg=#3A3C4E guifg=#626483 gui=bold

highlight! ALEErrorSign              guibg=#282936 guifg=#FF79C6 gui=bold
highlight! ALEWarningSign            guibg=#282936 guifg=#BD93F9 gui=bold

highlight! SignifySignAdd            guibg=#282936 guifg=#6699FF gui=bold
highlight! SignifySignDelete         guibg=#282936 guifg=#FF79C6 gui=bold
highlight! SignifySignChange         guibg=#282936 guifg=#BD93F9 gui=bold
